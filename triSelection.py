...
from generalFunctions import tri_selection

class SelectionSortView(QMainWindow):
    
    def __init__(self):
        super(SelectionSortView, self).__init__()
        #load the window interface file 
        loadUi('Views/triSelection.ui', self)
    ...
    def on_sortButton_clicked(self):
        if len(self.table) < 2 :
            ...
            self.table = tri_selection(self.table)
            self.updateTableView()
...
if __name__ == "__main__":
    ...
    window = SelectionSortView() # Create an instance of our class
