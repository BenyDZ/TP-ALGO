...
from generalFunctions import tri_Bulles

class BubbleSortView(QMainWindow):
    
    def __init__(self):
        super(BubbleSortView, self).__init__()
        #load the window interface file 
        loadUi('Views/trisBulles.ui', self)
    ...
    def on_sortButton_clicked(self):
        if len(self.table) < 2 :
            ...
            self.table = tri_Bulles(self.table)
            self.updateTableView()
...
if __name__ == "__main__":
    ...
    window = BubbleSortView() # Create an instance of our class
